...
package com.iblinfotech.foodierecipe.subscriptionmenu.util;
...
//        if (mDebugLog) Settings.Global.printLog(mDebugTag, msg);
    }

    void logError(String msg) {

//        Settings.Global.printLog(mDebugTag, "In-app billing error: " + msg);
    }
    ...
    public ArrayList<String> getPurchasesDetail() {
        ...
        try {
            ...
            ownedSkus = new ArrayList<String>();
            int response = ownedItems.getInt("RESPONSE_CODE");
            if (response == 0) {
                ownedSkus = ownedItems.getStringArrayList(GET_SKU_DETAILS_ITEM_LIST);
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
