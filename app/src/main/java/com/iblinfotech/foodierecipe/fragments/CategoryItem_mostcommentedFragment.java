...
public class CategoryItem_mostcommentedFragment extends Fragment {
    ...
    public CategoryItem_mostcommentedFragment() {
    }
...
//        linlaProgressBar.setVisibility(View.VISIBLE);
        Log.e("---loadMorePhotos--", "current_page---"+current_page);
        ...
        callWebServices.getMostCommentedRecipe(token, String.valueOf(current_page), new Callback<Response>() {
            @Override
...
//                        Log.e("SuccessData", "responseJsonArray---------more------- " + responseJsonArray);
                        ...
                        Log.e("----size----", "recipeItemTitleDatas--- " + newRecipeItemTitleDatas.size());
